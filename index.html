...
<head>
    ...
    <link href="css/children_matter.css" rel="stylesheet">
...
<body id="page-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link js-scroll-trigger active" href="#about">Lorem Ipsum 1</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link js-scroll-trigger" href="#experience">Lorem Ipsum 2</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
            <div class="">
                <h2 class="mb-5">Lorem Ipsum 1</h2>
                <div "resume-item d-flex flex-column flex-md-row mb-5">
                ...
                <div "resume-item d-flex flex-column flex-md-row mb-5">
                    <div class="col-lg-12 col-sm-6">
                        <img class="img-fluid" src="img/World_map_with_arbitrarily_red_coloured_states.png">
                    </div>
                </div>
                <div "resume-item d-flex flex-column flex-md-row mb-5">
                    <div class="resume-content mr-auto">
        ...
        <section class=" resume-section p-3 p-lg-5 d-flex flex-column" id="experience">
            <div class="">
                <h2 class="mb-5">Lorem Ipsum 2</h2>
        ...
        <section class=" resume-section p-3 p-lg-5 d-flex flex-column" id="education">
            <!-- <div class="my-auto"> -->
            <div class="">
                <h2 class="mb-5">Lorem Ipsum 3</h2>
